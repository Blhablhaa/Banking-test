...
<form method="post" <%-- modelAttribute="bankAccount" --%> >
  <div class="form-group col-xs-3">
    <label >Account Number</label> 
    <input type="text" class="form-control input-sm" name="accountNumber" <%-- value="${acct.accountNumber}" --%> placeholder="Enter Account Num"/>
